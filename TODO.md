...
- [ ] **Energy's top quartile still adds 18% against a 25% target** (measured, D1). Widening the knots did not fix it, which says the ceiling is in the track ladder rather than in the mapping: the full ladder is reached before the top of the dial, so there is nothing left to add. Needs the ladder thresholds spread, not the knots.
