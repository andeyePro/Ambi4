...
- [ ] **Build the patching system, then per-section differences** — his item 76, "Yes please", to the question of whether both come forward into the preset work and in that order. Patching is what makes a parameter do what you tell it rather than drift at random; per-section is what an instrument does in the chorus versus the verse.
