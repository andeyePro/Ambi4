...
- [ ] **The audible form of chord editing** — his amendment: "that only works for people who can hear chords in their head when they see the names, we need an audible version of this with a nice visual manipulator for those who can't." Names first was his own instruction; this is the follow-on, and the end goal is that it works for someone who plays any instrument or none.
