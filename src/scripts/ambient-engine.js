...
// Low / Mid / High. v0.0.65 renamed these to Kick / Snare / Hat, which the
// owner had not asked for and did not want — "High, Mid and Low is a good
// starting point", and the rows are click-to-rename anyway, so a user who
// wants a kit names one. Reverted at v0.0.66.
