...
| 6 | Modal section: `patch.modal.material` (enum), `.hardness`, `.damping`; chimes, marimba, the membrane kits read them | measured T60 scales with damping; partial ratios match the chosen table | – |
